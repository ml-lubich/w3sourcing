        ...
        <div className="grid md:grid-cols-3 gap-12 items-start">
            ...
            <div className="flex flex-col gap-3">
              {footerLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-white/30 hover:text-blue-light transition-colors duration-300 text-sm"
                >
                  {link.label}
                </a>
              ))}
          ...
          >
            ...
            <div className="space-y-3">
              <a href="mailto:info@w3sourcing.com" className="block text-white/30 hover:text-blue-light transition-colors text-sm">
                info@w3sourcing.com
              </a>
            ...
            <div className="mt-5">
              <a
                href="#"
                className="inline-flex items-center gap-2 text-white/20 hover:text-blue-light transition-colors text-sm"
                aria-label="LinkedIn"
              >
