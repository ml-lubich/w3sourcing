...
const steps = [
  {
    ...
    title: "Discovery",
    description:
      "We deeply understand your organisation, culture, team dynamics, and the specific qualities that define success in the role.",
  },
  {
    number: "02",
    title: "Targeted Search",
    description:
      "Leveraging sector-specific networks and rigorous assessment methodology, we identify and engage exceptional candidates.",
  },
  {
    number: "03",
    title: "Collaboration",
    description:
      "You're involved at every stage. Clear timelines, honest feedback, and regular updates — no black boxes, no surprises.",
  },
  {
    number: "04",
    title: "Partnership",
    description:
      "Our relationship doesn't end at placement. We ensure successful integration and continue to support your talent strategy.",
  },
];
...
export function HowWeWork() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="relative py-28 sm:py-36 bg-navy-light overflow-hidden"
    >
      {/* Parallax background */}
      <motion.div style={{ y: bgY }} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-blue/3 blur-[120px]" />
