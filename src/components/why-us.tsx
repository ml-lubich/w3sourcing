...
const reasons = [
  {
    ...
    description:
      "Our consultants are specialists, not generalists. Years of focused experience in Tech, Legal, and Finance.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "Presence across the US, UK, EU, UAE, and Asia — combining global network with deep local market intelligence.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "Great recruitment is built on relationships. Every search is led by experienced consultants who understand your culture.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "Discretion is non-negotiable. We operate with the highest standards of professional ethics and complete confidentiality.",
  },
];
...
export function WhyUs() {
  ...
  return (
    <section
      ref={sectionRef}
      id="why-us"
      className="relative py-28 sm:py-36 bg-navy overflow-hidden"
    >
      <motion.div style={{ y: bgY }} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-0 w-[500px] h-[500px] rounded-full bg-accent/3 blur-[120px]" />
        <div className="absolute bottom-1/4 right-0 w-[400px] h-[400px] rounded-full bg-blue/3 blur-[100px]" />
      </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((reason, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white mb-2 group-hover:text-blue-light transition-colors duration-300">
                {reason.title}
              </h3>
