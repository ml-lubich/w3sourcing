...
const offices = [
  ...
  },
  {
    ...
    address: "Far East Finance Building, 14 Robinson Road #08-01",
    timezone: "SGT (UTC+8)",
    flag: "🇸🇬",
  },
];
...
export function GlobalOffices() {
  return (
    <section className="relative py-28 sm:py-36 bg-navy-light overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue/3 blur-[120px] rounded-full" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white tracking-tight">
            Our <span className="gradient-text-blue">Offices</span>
          </h2>
          <p className="mt-5 text-lg text-white/35 max-w-2xl mx-auto leading-relaxed">
            Strategically positioned in two of the world&apos;s leading financial centres.
          </p>
        </motion.div>

        {/* World map visualization - abstract dots */}
        <motion.div
        ...
        >
          <div className="glass-card rounded-3xl p-8 sm:p-12 relative overflow-hidden">
            {/* Abstract globe connection line */}
            <div className="flex items-center justify-center gap-4 sm:gap-0">
              ...
              <motion.div
                ...
                className="flex-1 text-center sm:text-right sm:pr-12"
              >
              ...
              <div className="relative flex-shrink-0 w-20 sm:w-40">
                <motion.div
                  ...
                  className="h-px bg-gradient-to-r from-blue/50 via-blue to-blue/50 origin-left"
                />
                <motion.div
                  animate={{ scale: [1, 1.5, 1], opacity: [0.5, 1, 0.5] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-blue shadow-lg shadow-blue/50"
                />
              </div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.8 }}
                className="flex-1 text-center sm:text-left sm:pl-12"
              >
                <div className="inline-flex items-center gap-3 mb-3">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {offices.map((office, i) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-8 group hover:border-blue/15 transition-all duration-500"
            >
              <div className="flex items-start gap-4 mb-6">
                <span className="text-4xl">{office.flag}</span>
                <div>
                  <h3 className="text-xl font-bold text-white group-hover:text-blue-light transition-colors duration-300">
                    {office.city}
                  </h3>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-blue/50 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-blue/50 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
