...
const services = [
  {
    ...
    description:
      "We partner with high-growth, venture-backed technology companies to build transformative teams. From mid-level engineers to C-suite leadership.",
  ...
  },
  {
    ...
    description:
      "Placing exceptional lawyers at the world's leading US and UK law firms. From associate hires through to partner-level lateral moves.",
  ...
  },
  {
    ...
    description:
      "Connecting top-tier talent with global financial institutions. Investment banking, corporate finance, risk & compliance, and advisory.",
...
const accentColors: Record<string, { icon: string; tag: string; glow: string; border: string; line: string }> = {
  blue: {
    ...
    tag: "bg-blue/10 text-blue-light border-blue/10 hover:bg-blue/15 hover:border-blue/20",
    glow: "bg-blue/15",
    border: "group-hover:border-blue/15",
  ...
  gold: {
    ...
    tag: "bg-gold/10 text-gold-light border-gold/10 hover:bg-gold/15 hover:border-gold/20",
    glow: "bg-gold/15",
    border: "group-hover:border-gold/15",
  ...
  emerald: {
    ...
    tag: "bg-emerald-500/10 text-emerald-300 border-emerald-500/10 hover:bg-emerald-500/15 hover:border-emerald-500/20",
  ...
  return (
    <section ref={sectionRef} id="services" className="relative py-28 sm:py-36 bg-navy overflow-hidden">
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-accent/[0.02] blur-[100px] rounded-full" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          <motion.span
            ...
            className="inline-block text-blue font-semibold text-sm tracking-[0.2em] uppercase mb-4"
          >
            Our Expertise
          </motion.span>
          ...
          <motion.p
            ...
            className="mt-5 text-lg text-white/35 max-w-2xl mx-auto leading-relaxed"
          >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.tags.map((tag, ti) => (
                      <motion.span
                        ...
                        whileInView="visible"
                        viewport={{ once: true }}
                        className={`text-xs font-medium px-3 py-1.5 rounded-full border transition-all duration-300 cursor-default ${colors.tag}`}
                      >
                        {tag}
                      </motion.span>
                    ))}
